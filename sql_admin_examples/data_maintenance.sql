...
OPTIMIZE TABLE "ManufactureDB"."IoT_Sensors";
...
OPTIMIZE TABLE "ManufactureDB"."IoT_Sensors" REWRITE MANIFESTS;
...
VACUUM TABLE "ManufactureDB"."IoT_Sensors"
...
VACUUM TABLE "ManufactureDB"."IoT_Sensors" REMOVE ORPHAN FILES;
